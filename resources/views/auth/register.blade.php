            ...
            <div class="card" style="background-color: rgba(0, 0, 0, 0.8); color: white; padding: 20px; border-radius: 10px; text-align: center;">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="{{ __('Full Name') }}" style="background-color: white; border: none; color: black; margin-bottom: 15px; border-radius: 5px;">
                            @error('name')
                        ...
                        <div class="mb-3">
                            <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="{{ __('Email') }}" style="background-color: white; border: none; color: black; margin-bottom: 15px; border-radius: 5px;">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3 position-relative">
                            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="{{ __('Confirm Password') }}" style="background-color: white; border: none; color: black; margin-bottom: 15px; border-radius: 5px;">
                            <i class="fas fa-eye" id="toggleConfirmPassword" style="color: black; position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer;"></i>
                        </div>

                        <div class="mb-4 text-center">
                            <span style="color: white;">{{ __('Already have an account?') }} <a href="{{ route('login') }}" style="color: #ccc; text-decoration: none;">{{ __('Login here') }}</a></span>
                        </div>
