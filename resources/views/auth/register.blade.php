                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3 position-relative">
                                <input id="password" type="password" class="form-control pe-5" name="password" required
                                    autocomplete="new-password" placeholder="{{ __('Contraseña') }}"
                                    style="background-color: white; border: none; color: black; margin-bottom: 15px;">
                                <button type="button" id="togglePassword"
                                    class="btn position-absolute top-50 end-0 translate-middle-y"
                                    style="background-color: transparent; border: none; right: 10px;">
                            ...
                            <div class="mb-4 text-center">
                                <span style="color: white;">¿Ya tienes una cuenta? <a href="{{ route('login') }}"
                                        style="color: #ccc; text-decoration: none;">Ingresa Aquí</a></span>
                            </div>
