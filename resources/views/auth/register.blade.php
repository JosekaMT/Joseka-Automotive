            ...
            <div class="card" style="background-color: rgba(0, 0, 0, 0.8); color: white; padding: 20px; border-radius: 10px; text-align: center;">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="{{ __('Nombre') }}" style="background-color: white; border: none; color: black; margin-bottom: 15px;">
                            @error('name')
                        ...
                        <div class="mb-3">
                            <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="{{ __('Correo electrónico') }}" style="background-color: white; border: none; color: black; margin-bottom: 15px;">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3 position-relative">
                            <input id="password" type="password" class="form-control pe-5" name="password" required autocomplete="new-password" placeholder="{{ __('Contraseña') }}" style="background-color: white; border: none; color: black; margin-bottom: 15px;">
                        ...
                        <div class="mb-3 position-relative">
                            <input id="password-confirm" type="password" class="form-control pe-5" name="password_confirmation" required autocomplete="new-password" placeholder="{{ __('Confirmar Contraseña') }}" style="background-color: white; border: none; color: black; margin-bottom: 15px;">
                        ...
                        <div class="mb-4 text-center">
                            <span style="color: white;">¿Ya tienes una cuenta? <a href="{{ route('login') }}" style="color: #ccc; text-decoration: none;">Ingresa Aquí</a></span>
                        </div>
